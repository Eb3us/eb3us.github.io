...
<html>
  ...
  <head>
    <meta charset="utf-8">
    <title>ABnormal Design</title>
    <link href="https://fonts.googleapis.com/css2?family=Permanent+Marker&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="logo2.css" type="text/css" >
    <link rel="stylesheet" href="abnormal.css" type="text/css" media="screen and (min-width: 1024px)">
    <link rel="stylesheet" href="mobile.css" type="text/css" media="screen and (max-width: 1024px)">
    <script src="abnormal.js" defer></script>
  </head>
  ...
  <body>
    ...
    <div id="intro-tag" class="intro-tag">
      <img class="abbrain" src="abbrain.png"g alt=""><p id="subtitle">"Web design for times when normal is just not enough..."</p>
    </div>
        ...
        <h1 class="titleSmall1 works">Works</h1>
          ...
          <div class="column single-column">  
            ...
            <a href="https://southerncrossreview.org" title="Visit Abnormal Design's first webpage!">
              <img class="brain" src="scr2.png" alt="">
            </a>
